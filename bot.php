...
if(!file_exists('config.json')){
	$token = readline('Token Bot: ');
	$id = readline('Admin ID: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
				...
				if($chatId == $id){
                   ...
                   $bot->sendphoto([ 
                   'chat_id'=>$chatId,
                   'photo'=>"https://t.me/ii4i4_bot/7",
                   'caption'=>'Hi Bro 👋🏼\nTo Your Control Panel\nBy :- @SISSQ',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'إضافة حساب وهمي ⤵️','callback_data'=>'login']],
                          [['text'=>'صفحة التحكم 🛠️','callback_data'=>'back']],
                          [['text'=>'الجنرال المصري 🦁','url'=>'SISSQ']],              
                      ]
                  ])
              ]);   
          } elseif($text != null){
          			...
          			if(isset($body->message)){
          				if($body->message == 'challenge_required'){
          					$bot->sendMessage([
          							'chat_id'=>$chatId,
          							'parse_mode'=>'markdown',
          							'text'=>"لقد تم رفض الحساب لانه محظور او يطلب مصادقه ثنائيه ☠️"
          					]);
          				} else {
          					$bot->sendMessage([
          							'chat_id'=>$chatId,
          							'parse_mode'=>'markdown',
          							'text'=>"كلمه السر او اليوزر خطا 🤷🏼‍♂️"
          					]);
          				}
          				...
          				$bot->sendMessage([
          				      'parse_mode'=>'markdown',
          							'chat_id'=>$chatId,
          							'text'=>"تم اضافه الحساب بنجاح 👍🏼\nUsername: [$user](instagram.com/$user)
Name: {$body->full_name}",
'parse_mode'=>'markdown',
'reply_to_message_id'=>$mid		
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"صفحه التحكم الخاصه بك عزيزي 💯
 استمتع مع اسهل طريقه لسحب الحسابات و اقواها 🔱
لمراسله المطور - @SISSQ",
                    'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'إضافة حساب وهمي ⚙️','callback_data'=>'login']],
                          [['text'=>'سحب يوزرات 🗃️','callback_data'=>'grabber']],
                          [['text'=>'بدء الصيد 🔍','callback_data'=>'run'],['text'=>'إيقاف الصيد 🚫','callback_data'=>'stop']],
					...
					$bot->sendMessage([
							'chat_id'=>$chatId,
							'text'=>"اداة صيد متاحات الانستجرام باللغه العربيه",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'• المطور •','url'=>'t.me/SISSQ']],
                       [['text'=>"• قناة المطور •", 'url'=>"t.me/GNRAILMASR"]],
                      ]
                  ])
              ]);   
				}
          ...
          if($data == 'login'){
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        [['text'=>'من كلمات 🥀','callback_data'=>'search'],['text'=>'من هشتاج #️⃣','callback_data'=>'hashtag'],['text'=>'من اكسبلور 📊','callback_data'=>'explore']],
                        ...
                        [['text'=>'لستة جديده 📭','callback_data'=>'newList'],['text'=>'لستة قديمة 📬','callback_data'=>'append']],
                        [['text'=>'الصفحة الرئسية 🔙','callback_data'=>'back']],
                    ]
                ])
            ]);
          } elseif($data == 'search'){
